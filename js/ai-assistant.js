/**
 * Помощник Pampers: локальная база ответов в браузере (без сетевых запросов).
 */
(function () {
  "use strict";
  ...
  const KNOWLEDGE = [
    ...
    {
      phrases: ["pampers", "памперс", "памперсы", "procter"],
      keywords: ["pampers", "памперс", "памперсы", "procter", "джонсон"],
      minHits: 1,
      answer:
        "Pampers — бренд подгузников для малышей. На этом сайте можно посмотреть линейки: для новорожденных, активных малышей и ночную защиту.",
    },
    {
  ...
  const REGEX_INTENTS = [
    {
      ...
      answer:
        "Здравствуйте! Я отвечаю по базе типовых вопросов о подгузниках Pampers: размеры, смена, линейки, уход за кожей. По здоровью малыша консультируйтесь с врачом.",
    },
    {
    ...
    },
    {
      ...
      answer: "До свидания! Заходите снова, если понадобится подсказка по уходу или линейкам Pampers.",
    },
    {
